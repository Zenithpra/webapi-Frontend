...
export default class Dashboard extends Component {
    ...
    componentDidMount() {
        Axios.get('http://localhost:3000/tasks', this.state.config)
            .then((response) => {
    ...
    handleTodoSubmit = (e) => {
        ...
        Axios.post('http://localhost:3000/tasks', { name: this.state.currentTodo },
    ...
    updateTask = (updatedTask) => {
        ...
        Axios.put(`http://localhost:3000/tasks/${updatedTask._id}`,
